package io.heweiming.boot.generator.mybatis.bridge;
...
import io.heweiming.boot.generator.mybatis.model.DbType;
import io.heweiming.boot.generator.mybatis.model.GeneratorConfig;
import io.heweiming.boot.generator.mybatis.plugins.DbRemarksCommentGenerator;
    ...
    public void generate() throws Exception {
        ...
        if (generatorConfig.isOffsetLimit()) {
            if (DbType.MySQL.name().equals(selectedDatabaseConfig.getDbType())
                ...
                pluginConfiguration.addProperty("type", "io.heweiming.boot.generator.mybatis.plugins.MySQLLimitPlugin");
                pluginConfiguration.setConfigurationType("io.heweiming.boot.generator.mybatis.MySQLLimitPlugin");
